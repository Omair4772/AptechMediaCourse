...
public class cubeAiSystemGreen : MonoBehaviour
{
 [Header("CUBE SECTION")]
 ...
 [Header("BULLET CREATION SECTION")]
   ...
   public WinDecider winDecider;
    ...
    private void Update()
    {
        ...
        {
            CubeHitted = info.collider.gameObject.CompareTag("Blue") || info.collider.gameObject.CompareTag("Red");
        }
        else
        {
            return;
